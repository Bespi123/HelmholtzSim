...
def coil_simulation_parallel(X, Y, Z, coil_params, current, spires_np, batch_size, enable_progress_bar=True, n=100):
    """
    ...
    for k in range(0, len(X_flat), batch_size):
        ...
        B = magnetic_field_coil_parallel(P_batch, coil_params.N, current, coils, n)
